...
var argv = require('yargs/yargs')(process.argv.slice(2))
    ...
    .nargs('k', 1)
    .default('k', ['landscape'])
    .describe('k', 'The Unsplash keywords that will be used to fetch the backgrounds')
    .alias('t', 'title')
    .nargs('t', 1)
    .default('t', '')
...
function main() {
    ...
    lineReader.on('close', function (line) {
        ...
        for (var i = 0; i < slides.length; i++) {
            request('https://source.unsplash.com/featured/1600x900/?'+ argv.k +'?sig' + i).pipe(fs.createWriteStream(dir + '/img' + i + '.png'), {flags: 'w'}).on('close', function() {
                completedSlides++;
